      ...
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <nav className="flex gap-6">
            ...
            <Link href="/about" className="font-medium text-indigo-600 text-base">
              About
            </Link>
            <Link
              href="/partnership"
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Born in Colombia and raised in South Florida, Leonardo Ortegon comes from a family deeply rooted in
                    the jewelry trade since the 1980s. From a young age, he was immersed in the craft—learning
                    everything from sales and design to CAD, stone setting, and bench work while working at his family’s
                    store, Precious Moments Jewelers.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    After years of hands-on experience, Leonardo saw a new opportunity: creators and influencers wanted
                    to launch their own jewelry lines, but had no access to the production quality or support trusted by
                    traditional jewelers. That insight sparked Gemsite—a platform that empowers modern creators to
                    launch luxury, made-to-order jewelry brands without managing inventory or logistics.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Today, Gemsite blends expert craftsmanship with behind-the-scenes fulfillment, offering creators a
                    true white-label solution. Every piece is made-to-order by professional jewelers and shipped
                    directly to the customer, under the creator’s name. Leonardo’s goal is simple: to make high-end
                    jewelry branding as effortless as content creation.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Still deeply connected to his family’s store, Leonardo continues to work closely with Precious
                    Moments Jewelers while building Gemsite into a trusted production backbone for a new generation of
                    jewelry businesses. For him, it’s about more than just manufacturing—it’s about creating the kind of
                    partnership he always wished existed when he was on the retail side of the counter.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Creator-First</h3>
                  <p className="text-slate-600">
                    Every decision we make puts creators at the center. Your success is our success.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Quality Excellence</h3>
                  <p className="text-slate-600">
                    We never compromise on materials or craftsmanship. Every piece reflects luxury standards.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-slate-600">
                    We constantly evolve our platform and processes to serve creators better.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-slate-600">
                    We build long-term relationships, not just transactions. We grow together.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-slate-900 text-lg">Accessible Luxury</div>
                      <div className="text-slate-600">
                        Making high-end jewelry brands accessible to creators of all sizes and backgrounds.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-slate-900 text-lg">Sustainable Growth</div>
                      <div className="text-slate-600">
                        Building long-term value for creators through ethical practices and quality craftsmanship.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-slate-900 text-lg">Creative Freedom</div>
                      <div className="text-slate-600">
                        Empowering creators to express their unique vision through beautiful, custom jewelry.
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-left md:text-center space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-indigo-100 max-w-2xl mx-auto">
                  Join hundreds of creators who've already launched their jewelry brands with Gemsite. Your luxury brand
                  awaits.
                </p>
              </div>
              ...
              <p className="text-sm text-indigo-200">No upfront costs • No inventory required • 50% revenue share</p>
            </div>
          </div>
        </section>
      </main>
