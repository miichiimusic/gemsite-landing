      ...
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <nav className="flex gap-6">
            ...
            <Link href="/partnership" className="font-medium text-indigo-600 text-base">
              Partnership
            </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <MobileMenu currentPage="partnership" />
        </div>
      </header>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-4 bg-emerald-50 rounded-lg">
                        ...
                        <div className="text-center mb-3">
                          <div className="text-2xl font-bold text-emerald-700">$550</div>
                          <div className="text-sm text-emerald-600">($1,000 - $450 costs)</div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center p-3 bg-emerald-100 rounded">
                            <div className="font-semibold text-emerald-900">Your Share</div>
                            <div className="text-xl font-bold text-emerald-700">$275</div>
                          ...
                          <div className="text-center p-3 bg-slate-100 rounded">
                            ...
                            <div className="text-xl font-bold text-slate-600">$275</div>
